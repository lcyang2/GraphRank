...
class EnGCN(torch.nn.Module):
    ...
    def train_and_test(self, input_dict):
        ...
        for i in range(self.num_layers):
            ...
            # path_save = './save/{}_EnGCN'.format(self.dataset)
        ...
        # inf_start = time.time()
        # out_10 = self.model.inference_10(x, y_emb, device, self.use_label_mlp)
        # inf_end = time.time()
        # print("inference:{}\n".format(inf_end-inf_start))   
        # for i in range(10):
        #     path_save_out10 = './dropout/{}_EnGCN/out_{}'.format(self.dataset, i)
        #     torch.save(out_10[i], path_save_out10)
